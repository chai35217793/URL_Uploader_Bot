...
class URLDL:
    ...
    async def start(self):
        ...
        if len_file == 'Valid':
            msg = await self.bot.edit_message_text(self.userid, self.process_msg_id, BotMessage.starting_to_download, parse_mode=ParseMode.HTML)
            ...
            try:
                ...
                await self.bot.edit_message_text(self.userid, msg.message_id, BotMessage.unsuccessful_upload, parse_mode=ParseMode.HTML)
            else:
            ...
            await self.bot.edit_message_text(self.userid, self.process_msg_id, BotMessage.telegramLimit, parse_mode=ParseMode.HTML)
        elif len_file == 'Not Valid':
            await self.bot.edit_message_text(self.userid, self.process_msg_id, BotMessage.unsuccessful_upload, parse_mode=ParseMode.HTML)
